...
type Tab = "dashboard" | "add_marks" | "report_card" | "analytics";
...
export default function FacultyPage({ username, onLogout }: FacultyPageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col" data-ocid="faculty.page">
      {/* Mobile top bar */}
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  data-ocid={`faculty.${item.id}_tab`}
                >
